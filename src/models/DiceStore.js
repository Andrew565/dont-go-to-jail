...
export class DiceStore {
  ...
  hasGoToJail() {
    ...
    const numberOfWords = this.wordDice.reduce((matches, die) => {
      return matches + (die.current_face !== null);
    }, 0);
  ...
  dieBelongsToPropType(die, propertyType) {
    ...
    return dieFace === propertyType || (propertyType === "Utils" && (dieFace === "Lightbulb" || dieFace === "Water"));
  }
